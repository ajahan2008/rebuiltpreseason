...
public class LimelightOne {
  ...
  public LimelightOne() {
    ...
    System.out.println("Limelight-one initialized!");
  }
  ...
  public static double hasValidTargets() {
    return NetworkTableInstance.getDefault().getTable("limelight-one").getEntry("tv").getDouble(0);
  }
  ...
  public static double getVerticalOffset() {
    return NetworkTableInstance.getDefault().getTable("limelight-one").getEntry("ty").getDouble(0);
  }
  ...
  public static double getHorizontalOffset() {
    return NetworkTableInstance.getDefault().getTable("limelight-one").getEntry("tx").getDouble(0);
  }
  ...
  public static double[] getTagID() {
    return NetworkTableInstance.getDefault().getTable("limelight-one").getEntry("tid").getDoubleArray(new double[6]);
  }
